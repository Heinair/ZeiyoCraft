...

{
	...
	public static ArmorMaterial BRONZEA = EnumHelper.addArmorMaterial("BRONZEA", "zeiyocraft:bronze", 19, new int[] {3,6,5,2}, 9);
	public static ToolMaterial ELECTRUM = EnumHelper.addToolMaterial("ELECTRUM", 2, 500, 7.5F, 2.0F, 13);
	public static ArmorMaterial ELECTRUMA = EnumHelper.addArmorMaterial("ELECTRUMA", "zeiyocraft:electrum", 19, new int[] {2,6,5,3}, 9);
	public static ToolMaterial STEEL = EnumHelper.addToolMaterial("STEEL", 2, 750, 6.0F, 2.0F, 13);
	public static ArmorMaterial STEELA = EnumHelper.addArmorMaterial("STEEL", "zeiyocraft:steel", 19, new int[] {2,6,6,2}, 9);
	public static ToolMaterial ONYX = EnumHelper.addToolMaterial("ONYX", 3, 2556, 8.0F, 3.0F, 14);
	public static ArmorMaterial ONYXA = EnumHelper.addArmorMaterial("ONYX", "zeiyocraft:onyx", 40, new int[] {3, 8, 6, 3}, 14);
	public static ToolMaterial RUBY = EnumHelper.addToolMaterial("RUBY", 3, 1561, 8.0F, 4.0F, 10);
	public static ArmorMaterial RUBYA = EnumHelper.addArmorMaterial("RUBY", "zeiyocraft:ruby", 33, new int[] {3, 8, 6, 3}, 10);
	public static ToolMaterial SAPPHIRE = EnumHelper.addToolMaterial("SAPPHIRE", 3, 1561, 10.0F, 3.0F, 10);
	public static ArmorMaterial SAPPHIREA = EnumHelper.addArmorMaterial("SAPPHIRE", "zeiyocraft:sapphire", 33, new int[] {3, 8, 6, 3}, 10);
	public static ToolMaterial EMERALD = EnumHelper.addToolMaterial("EMERALD", 3, 1761, 8.5F, 3.5F, 18);
	public static ArmorMaterial EMERALDA = EnumHelper.addArmorMaterial("EMERALD", "zeiyocraft:emerald", 33, new int[] {3, 8, 6, 3}, 18);
