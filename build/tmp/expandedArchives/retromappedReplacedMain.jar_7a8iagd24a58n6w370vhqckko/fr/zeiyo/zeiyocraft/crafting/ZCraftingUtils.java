...
public class ZCraftingUtils
{
    ...
    {
        GameRegistry.addRecipe(new ItemStack(pickaxe), new Object[] {"###", " P ", " P ",'P', Items.field_151055_y, '#', item});
    }

    public static void axeCraft(Item item, Item axe)
    {
        GameRegistry.addRecipe(new ItemStack(axe), new Object[] {"## ", "#P ", " P ",'P', Items.field_151055_y, '#', item});
    }

    public static void spadeCraft(Item item, Item spade)
    {
        GameRegistry.addRecipe(new ItemStack(spade), new Object[] {" # ", " P ", " P ",'P', Items.field_151055_y, '#', item});
    }

    public static void hoeCraft(Item item, Item hoe)
    {
        GameRegistry.addRecipe(new ItemStack(hoe), new Object[] {"## ", " P ", " P ",'P', Items.field_151055_y, '#', item});
    }

    public static void swordCraft(Item item, Item sword)
    {
        GameRegistry.addRecipe(new ItemStack(sword), new Object[] {" # ", " # ", " P ",'P', Items.field_151055_y, '#', item});
    }

    public static void warAxeCraft(Item item, Item warAxe)
    {
        GameRegistry.addRecipe(new ItemStack(warAxe), new Object[] {"###", "#P#", " P ", 'P', Items.field_151055_y, '#', item});
    }
    public static void warAxeCraft(Block block, Item warAxe)
    {
        GameRegistry.addRecipe(new ItemStack(warAxe), new Object[] {"###", "#P#", " P ", 'P', Items.field_151055_y, '#', block});
    }
    ...
    public static Item getRepairItem(int id)
    {
        ...
        switch(id)
        {
            ...
            case 100 : return Items.field_151043_k;
            case 101 : return Items.field_151042_j;
            case 102 : return Items.field_151045_i;
