...

{
	...
	{
        Minecraft.func_71410_x().func_175599_af().func_175037_a().func_178086_a(item, 0, new ModelResourceLocation(ZeiyoMain.MODID+ ":" + item.func_77658_a().substring(5), "inventory"));
	}
